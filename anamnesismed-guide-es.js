...
var GUIDE_ES = {
  ...
  "expectoracao": {
    ...
    "ddx": [
      [
        "Bronquitis aguda",
        "Esputo mucopurulento, fiebre baja, IRS previa, tos < 3 sem",
        "Fétido, vómica, pérdida de peso"
      ],
      [
        "Neumonía bacteriana",
        "Fiebre alta, crepitantes focales, esputo purulento/herrumbroso",
        "Crónico, sin fiebre, vómica"
      ],
      [
        "EPOC agudizado",
        "Fumador, esputo mucopurulento, empeoramiento disnea",
        "Fiebre alta, hemoptisis franca, joven"
      ],
      [
        "Bronquiectasia",
        "Esputo abundante/fétido matutino, crónico, dedos en palillo",
        "Agudo, sin dedos en palillo"
      ],
      [
        "Absceso pulmonar",
        "Vómica, esputo fétido, fiebre alta, cavidad en Rx",
        "Crónico, sin vómica"
      ],
      [
        "TB pulmonar",
        "Crónico, esputo numular, sudoración nocturna, pérdida de peso",
        "Agudo febril, sin contacto TB"
      ]
    ],
    "conduta": {
      "exames": [
  ...
  "hemoptise": {
    ...
    "ddx": [
      [
        ...
        "Fumador, esputo hemoptoico leve, crónico, sin pérdida de peso",
        "Volumen alto, masa Rx, pérdida de peso"
      ],
      [
        "Carcinoma broncogénico",
        "Fumador > 40 años, pérdida de peso, masa Rx, adenopatías",
        "Joven, sin tabaquismo, fiebre alta"
      ],
      [
        "TB pulmonar",
        "Contacto TB, sudoración nocturna, pérdida de peso, cavidad Rx",
        "Sin contacto, agudo febril sin síntomas B"
      ],
      [
        "Bronquiectasia",
        "Esputo abundante fétido matutino, dedos en palillo, desde infancia",
        "Agudo, sin esputo abundante"
      ],
      [
        "TEP",
        "Pleurítico, TVP, taquicardia, Dímero-D ↑, hipoxemia",
        "Fiebre alta, cavidad Rx, pérdida de peso"
      ],
      [
        "Estenosis mitral",
        "Soplo mitral, ortopnea, FA, disnea de esfuerzo",
        "Sin cardiopatía, sin soplo"
      ]
    ],
    "conduta": {
      "exames": [
  ...
  "ictericia": {
    "mnemonics": [
      {
        ...
        "rows": [
          [
            "Aumento de bilirrubina indirecta por hemólisis o eritropoyesis ineficaz",
            "Anemia, esplenomegalia, orina oscura pero heces normales, sin prurito, hemólisis (reticulocitosis, LDH↑, haptoglobina↓)",
            "Prehepática (hemolítica)"
          ],
          [
            "Lesión de los hepatocitos que afecta la captación/conjugación/excreción de la bilirrubina",
            "Transaminasas muy elevadas, malestar, anorexia, hepatomegalia dolorosa, antecedente de hepatitis/etilismo/hepatotóxicos",
            "Hepática (hepatocelular)"
          ],
          [
            "Obstrucción del flujo biliar (cálculo, neoplasia, estenosis)",
            "Coluria + acolia fecal + prurito intenso, dolor en HCD, FA y GGT muy elevadas, posible signo de Courvoisier",
            "Posthepática (colestásica/obstructiva)"
          ]
        ]
      }
    ],
    "manobras": [
      {
        "title": "Signo de Murphy",
        "subtitle": "Evaluación de colecistitis aguda",
        "steps": [
          "Coloque los dedos bajo el reborde costal derecho, en la línea hemiclavicular",
          "Pida al paciente inspirar profundamente",
          "Observe si hay interrupción súbita de la inspiración por dolor (Murphy positivo)"
        ],
        "normal": "El paciente completa la inspiración sin dolor",
        "abnormal": "Interrupción de la inspiración por dolor a la palpación del punto cístico (Murphy+) → sugiere colecistitis aguda"
      },
      {
        "title": "Palpación hepática y esplénica",
        "subtitle": "Evaluación de hepatomegalia/esplenomegalia",
        "steps": [
          "Palpe el reborde hepático desde la fosa ilíaca derecha, subiendo durante la espiración",
          "Evalúe consistencia, superficie, borde y dolor a la palpación del hígado",
          "Palpe el hipocondrio izquierdo en busca de bazo palpable (esplenomegalia)"
        ],
        "normal": "Hígado no palpable o borde liso, indoloro, hasta 1-2cm del reborde costal; bazo no palpable",
        "abnormal": "Hepatomegalia de borde romo/irregular (sugiere hepatopatía crónica/neoplasia) o esplenomegalia (sugiere causa hemolítica/hipertensión portal)"
      },
      {
        "title": "Búsqueda del signo de Courvoisier",
        "subtitle": "Vesícula biliar palpable e indolora asociada a ictericia",
        "steps": [
          "Palpe el hipocondrio derecho en busca de masa redondeada compatible con vesícula biliar distendida",
          "Evalúe si hay dolor asociado a la palpación"
        ],
        "normal": "Vesícula no palpable",
        "abnormal": "Vesícula biliar palpable e indolora en paciente ictérico (Courvoisier+) → sugiere obstrucción biliar maligna (ej.: neoplasia de cabeza de páncreas), ya que los cálculos suelen causar vesícula fibrótica no distensible"
      },
      {
        "title": "Búsqueda de ascitis — onda ascítica y matidez desplazable",
        "subtitle": "Evaluación de líquido libre en la cavidad abdominal",
        "steps": [
          "Onda ascítica: percuta un flanco mientras un asistente comprime la línea media y palpe la transmisión de la onda en el flanco opuesto",
          "Matidez desplazable: percuta del centro (timpánico) hacia los flancos (mate) y repita tras cambiar de decúbito, observando el desplazamiento de la matidez"
        ],
        "normal": "Sin transmisión de onda líquida; sin desplazamiento de la matidez con el cambio de posición",
        "abnormal": "Onda líquida transmitida (onda ascítica+) o matidez que se desplaza con la posición (matidez desplazable+) → sugiere ascitis, común en hepatopatía crónica avanzada"
      }
    ],
    "sinais": [
      {
        "name": "Ictericia escleral",
        "eponym": "Signo precoz de hiperbilirrubinemia",
        "how": "Coloración amarillenta de la esclera, generalmente perceptible con bilirrubina total >2-3mg/dL",
        "means": "Indica hiperbilirrubinemia — frecuentemente el primer signo clínico visible de ictericia, antes de la piel"
      },
      {
        "name": "Arañas vasculares (spiders/telangiectasias)",
        "eponym": "Estigma de hepatopatía crónica",
        "how": "Lesiones vasculares puntiformes con ramificaciones radiales, que palidecen a la compresión central, generalmente en tórax y cara",
        "means": "Sugieren hepatopatía crónica e hiperestrogenismo (metabolismo hepático alterado de los estrógenos)"
      },
      {
        "name": "Hepatomegalia",
        "eponym": "Hallazgo de examen físico hepatobiliar",
        "how": "Hígado palpable más allá del reborde costal derecho, con evaluación de borde, superficie y consistencia",
        "means": "Puede indicar congestión (insuficiencia cardíaca), infiltración (esteatosis, neoplasia) o proceso inflamatorio/infeccioso hepático"
      },
      {
        "name": "Signo de Courvoisier",
        "eponym": "Ludwig Georg Courvoisier",
        "how": "Vesícula biliar palpable e indolora en paciente ictérico",
        "means": "Sugiere obstrucción biliar de origen neoplásico (ej.: cáncer de cabeza de páncreas o vía biliar) — \"una vesícula de Courvoisier rara vez es causada por un cálculo\""
      }
    ],
    "ddx": [
      [
        "Ictericia hemolítica (prehepática)",
        "Predominio de bilirrubina indirecta, anemia, esplenomegalia, orina oscura pero heces de color normal, ausencia de prurito, reticulocitosis y LDH elevado",
        "Predominio de bilirrubina directa, transaminasas o enzimas canaliculares muy elevadas, acolia fecal"
      ],
      [
        "Ictericia hepatocelular (hepatitis/cirrosis)",
        "Transaminasas (TGO/TGP) marcadamente elevadas, malestar, anorexia, hepatomegalia dolorosa, antecedente de etilismo/hepatotóxicos/hepatitis viral, signos de hepatopatía crónica (arañas vasculares, ascitis)",
        "Predominio de FA/GGT con transaminasas poco alteradas, prurito intenso y acolia, sugiriendo causa colestásica"
      ],
      [
        "Ictericia colestásica/obstructiva (coledocolitiasis, neoplasia de vía biliar/páncreas)",
        "Coluria + acolia fecal + prurito importante, dolor en HCD o epigastrio, fosfatasa alcalina y GGT muy elevadas, posible signo de Courvoisier (obstrucción neoplásica) o fiebre/escalofríos (colangitis)",
        "Patrón predominante de elevación de transaminasas sin colestasis de laboratorio, ausencia de dilatación de vías biliares en la imagen"
      ]
    ],
    "escalas": [
      {
        "title": "Patrón bioquímico orientador según el tipo de ictericia",
        "headers": [
          "Tipo",
          "Patrón de laboratorio predominante"
        ],
        "rows": [
          [
            "Prehepática (hemolítica)",
            "Bilirrubina indirecta ↑↑, transaminasas normales, FA/GGT normales, reticulocitos y LDH elevados, haptoglobina baja"
          ],
          [
            "Hepatocelular",
            "Transaminasas (TGO/TGP) muy elevadas, bilirrubina directa e indirecta elevadas, FA/GGT discretamente elevadas"
          ],
          [
            "Colestásica/obstructiva",
            "Fosfatasa alcalina y GGT muy elevadas, bilirrubina directa predominante, transaminasas discretamente alteradas, USG con posible dilatación de vías biliares"
          ]
        ],
    ...
    "conduta": {
      "exames": [
        "Bilirrubinas totales y fracciones (directa/indirecta) — define el predominio y orienta la investigación",
        "Transaminasas (TGO/TGP), fosfatasa alcalina (FA) y gamma-GT — diferencian el patrón hepatocelular del colestásico",
        "Hemograma completo, reticulocitos, LDH y haptoglobina — si sospecha de causa hemolítica",
        "Serologías virales (hepatitis A, B, C) según factores de riesgo y cuadro clínico",
        "Ultrasonografía abdominal — examen inicial de elección para evaluar vías biliares, vesícula, hígado y páncreas, e identificar dilatación de vía biliar (sugestiva de obstrucción)",
        "Tomografía/colangiorresonancia y endoscopia (CPRE) según hallazgos — para casos con sospecha de obstrucción biliar no aclarada por la USG"
      ],
      "drugs": [
        "Tratamiento dirigido a la causa de base — no hay tratamiento sintomático específico para la ictericia en sí",
        "Suspender inmediatamente medicamentos/sustancias potencialmente hepatotóxicas identificadas en la anamnesis",
        "Colestiramina o antihistamínicos pueden considerarse para alivio sintomático del prurito colestásico, según evaluación especializada",
        "Colangitis aguda (fiebre + ictericia + dolor en HCD — tríada de Charcot) → antibioticoterapia de amplio espectro y evaluación para drenaje biliar de urgencia"
      ],
      "steps": [
        "1. Caracterizar el patrón temporal, presencia de coluria/acolia/prurito y signos de alarma (fiebre, dolor importante, pérdida de peso, masa palpable)",
        "2. Examen físico dirigido — buscar hepatomegalia, esplenomegalia, signo de Murphy, signo de Courvoisier y ascitis",
        "3. Solicitar bilirrubinas con fracciones, transaminasas, FA/GGT y hemograma para clasificar el patrón (prehepático, hepatocelular o colestásico)",
        "4. Ultrasonografía abdominal para evaluar dilatación de vías biliares, lesiones hepáticas/pancreáticas y vesícula",
        "5. Signos de colangitis (fiebre + ictericia + dolor) u obstrucción biliar identificada → derivación urgente para evaluación quirúrgica/endoscópica (CPRE)",
        "6. Sospecha de hepatitis aguda/crónica o hepatopatía avanzada → derivación a hepatología/gastroenterología para investigación etiológica completa"
      ]
    }
  },
  "lombalgia": {
